...
import {IPublicApiHotkey, IPublicTypeHotkeyCallback, IPublicTypeHotkeyCallbackConfig, IPublicTypeHotkeyCallbacks} from './types'
...
export type IHotKey = IPublicApiHotkey
